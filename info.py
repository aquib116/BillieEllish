...
PICS = (environ.get('PICS', 'https://envs.sh/AAl.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/AAl.jpg")
MELCOW_PIC = environ.get("MELCOW_PIC", "https://envs.sh/AAl.jpg")
...
TUTORIAL = environ.get('TUTORIAL', 'howuseme/9')
